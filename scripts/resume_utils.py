...
LOCALIZED_TEXT = {
    "en": {
        ...
        "save": "Save",
        "saving": "Saving…",
        "saved": "Saved to resume.json",
        "save_failed": "Save failed — use Copy JSON",
        "sync_offline": "Sync server unavailable — use Copy JSON",
    },
    "zh": {
        "summary": "个人简介",
        "experience": "工作经历",
        ...
        "save": "保存",
        "saving": "保存中…",
        "saved": "已保存到 resume.json",
        "save_failed": "保存失败 — 请使用复制 JSON",
        "sync_offline": "同步服务不可用 — 请使用复制 JSON",
    },
    "ja": {
        "summary": "プロフィール",
        "experience": "職歴",
        ...
        "save": "保存",
        "saving": "保存中…",
        "saved": "resume.json に保存しました",
        "save_failed": "保存に失敗 — JSON コピーを使用してください",
        "sync_offline": "同期サーバーが利用できません — JSON コピーを使用してください",
    },
    "fr": {
        ...
        "recent_colors": "Couleurs recentes",
        "save": "Enregistrer",
        "saving": "Enregistrement…",
        "saved": "Enregistre dans resume.json",
        "save_failed": "Echec de l'enregistrement — utilisez Copier JSON",
        "sync_offline": "Serveur de sync indisponible — utilisez Copier JSON",
    },
    "de": {
        ...
        "color": "Farbe",
        "pick_color": "Farbe wahlen",
        "recent_colors": "Zuletzt verwendet",
        "save": "Speichern",
        "saving": "Speichern…",
        "saved": "In resume.json gespeichert",
        "save_failed": "Speichern fehlgeschlagen — JSON kopieren verwenden",
        "sync_offline": "Sync-Server nicht verfügbar — JSON kopieren verwenden",
    },
    "es": {
        ...
        "save": "Guardar",
        "saving": "Guardando…",
        "saved": "Guardado en resume.json",
        "save_failed": "Error al guardar — use Copiar JSON",
        "sync_offline": "Servidor de sincronizacion no disponible — use Copiar JSON",
    },
}
